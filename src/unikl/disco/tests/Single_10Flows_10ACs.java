	...
	public void f0_tfa_fifoMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "TFA FIFO delay", Num.createNum( 15.5 ), tfa.getDelayBound() );
				assertEquals( "TFA FIFO backlog", Num.createNum( 110 ), tfa.getBacklogBound() );
			} catch (Exception e) {
	...
	public void f0_tfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "TFA ARB delay", Num.createNum( 310, 9 ), tfa.getDelayBound() );
				assertEquals( "TFA ARB backlog", Num.createNum( 110 ), tfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "TFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f0_sfa_fifoMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA FIFO delay", Num.createNum( 1796, 115 ), sfa.getDelayBound() );
				assertEquals( "SFA FIFO backlog", Num.createNum( 127, 50 ), sfa.getBacklogBound() );
			} catch (Exception e) {
	...
	public void f0_sfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA ARB delay", Num.createNum( 775, 23 ), sfa.getDelayBound() );
				assertEquals( "SFA ARB backlog", Num.createNum( 100, 23 ), sfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "SFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f0_pmoo_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "PMOO ARB delay", Num.createNum( 775, 23 ), pmoo.getDelayBound() );
				assertEquals( "PMOO ARB backlog", Num.createNum( 100, 23 ), pmoo.getBacklogBound() );
			} catch (Exception e) {
	...
	public void f0_sinktree_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "Tree backlog", 110, backlog_bound, 0.0 );
			} catch (Exception e) {
	...
	public void f6_sfa_fifoMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA FIFO delay", Num.createNum( 2099, 130 ), sfa.getDelayBound() );
				assertEquals( "SFA FIFO backlog", Num.createNum( 434, 25 ), sfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "SFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f6_sfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA ARB delay", Num.createNum( 775, 26 ), sfa.getDelayBound() );
				assertEquals( "SFA ARB backlog", Num.createNum( 350, 13 ), sfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "SFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f6_pmoo_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "PMOO ARB delay", Num.createNum( 775, 26 ), pmoo.getDelayBound() );
				assertEquals( "PMOO ARB backlog", Num.createNum( 350, 13 ), pmoo.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "PMOO analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
