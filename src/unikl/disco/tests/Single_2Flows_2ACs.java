 ...
 *
 */
public class Single_2Flows_2ACs extends FunctionalTests
{
	static Network network;
	static Server s0;
	static Flow f0, f1;
	 
	public Single_2Flows_2ACs( FunctionalTestConfig test_config ) {
		super( test_config );
	}
	...
	public void createNetwork()
	{
		...
		ArrivalCurve arrival_curve_0 = ArrivalCurve.createTokenBucket( 4, 10 );
		ArrivalCurve arrival_curve_1 = ArrivalCurve.createTokenBucket( 5, 25 );
	...
	public void f0_tfa_fifoMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "TFA FIFO delay", Num.createNum( 13.5 ), tfa.getDelayBound() );
				assertEquals( "TFA FIFO backlog", Num.createNum( 125 ), tfa.getBacklogBound() );
			} catch (Exception e) {
	...
	public void f0_tfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "TFA ARB delay", Num.createNum( 135 ), tfa.getDelayBound() );
				assertEquals( "TFA ARB backlog", Num.createNum( 125 ), tfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "TFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f0_sfa_fifoMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA FIFO delay", Num.createNum( 29, 2 ), sfa.getDelayBound() );
				assertEquals( "SFA FIFO backlog", Num.createNum( 60 ), sfa.getBacklogBound() );
			} catch (Exception e) {
	...
	public void f0_sfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA ARB delay", Num.createNum( 27 ), sfa.getDelayBound() );
				assertEquals( "SFA ARB backlog", Num.createNum( 110 ), sfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "SFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f0_pmoo_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "PMOO ARB delay", Num.createNum( 27 ), pmoo.getDelayBound() );
				assertEquals( "PMOO ARB backlog", Num.createNum( 110 ), pmoo.getBacklogBound() );
			} catch (Exception e) {
	...
	public void f0_sinktree_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "Tree backlog", 125, backlog_bound, 0.0 );	
			} catch (Exception e) {
	...
	public void f1_sfa_fifoMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA FIFO delay", Num.createNum( 91, 6 ), sfa.getDelayBound() );
				assertEquals( "SFA FIFO backlog", Num.createNum( 80 ), sfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "SFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f1_sfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA ARB delay", Num.createNum( 22.5 ), sfa.getDelayBound() );
				assertEquals( "SFA ARB backlog", Num.createNum( 350, 3 ), sfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "SFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f1_pmoo_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "PMOO ARB delay", Num.createNum( 22.5 ), pmoo.getDelayBound() );
				assertEquals( "PMOO ARB backlog", Num.createNum( 350, 3 ), pmoo.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "PMOO analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
