 ...
 *
 */
public class Tandem_1SC_2Flows_1AC_2Paths_v2 extends FunctionalTests
{
	static Network network;
	static Server s0, s1, s2, s3;
	static Flow f0, f1;
	 
	public Tandem_1SC_2Flows_1AC_2Paths_v2( FunctionalTestConfig test_config ) {
		super( test_config );
	}
	...
	public void f0_tfa_fifoMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "TFA FIFO delay", Num.createNum( 7985, 64 ), tfa.getDelayBound() );
				assertEquals( "TFA FIFO backlog", Num.createNum( 550 ), tfa.getBacklogBound() );
			} catch (Exception e) {
	...
	public void f0_tfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				if( test_config.arrivalBoundMethods().contains( ArrivalBoundMethod.PMOO ) ) {
					assertEquals( "TFA ARB delay", Num.createNum( 765, 4 ), tfa.getDelayBound() );
					assertEquals( "TFA ARB backlog", Num.createNum( 550 ), tfa.getBacklogBound() );
				} else {
					assertEquals( "TFA ARB delay", Num.createNum( 2335, 12 ), tfa.getDelayBound() );
					assertEquals( "TFA ARB backlog", Num.createNum( 1700, 3 ), tfa.getBacklogBound() );
				}
			} catch (Exception e) {
				System.out.println( "TFA analysis failed" );
				System.out.println( e.toString() );
	...
	public void f0_sfa_fifoMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA FIFO delay", Num.createNum( 535, 6 ), sfa.getDelayBound() );
				assertEquals( "SFA FIFO backlog", Num.createNum( 925, 2 ), sfa.getBacklogBound() );
			} catch (Exception e) {
	...
	public void f0_sfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA ARB delay", Num.createNum( 105 ), sfa.getDelayBound() );
				assertEquals( "SFA ARB backlog", Num.createNum( 1625, 3 ), sfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "SFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f0_pmoo_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "PMOO ARB delay", Num.createNum( 290, 3 ), pmoo.getDelayBound() );
				assertEquals( "PMOO ARB backlog", Num.createNum( 500 ), pmoo.getBacklogBound() );
			} catch (Exception e) {
	...
	public void f1_tfa_fifoMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "TFA FIFO delay", Num.createNum( 65 ), tfa.getDelayBound() );
				assertEquals( "TFA FIFO backlog", Num.createNum( 550 ), tfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "TFA analysis failed" );
				System.out.println( e.toString() );
	...
	public void f1_tfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "TFA ARB delay", Num.createNum( 130 ), tfa.getDelayBound() );
				assertEquals( "TFA ARB backlog", Num.createNum( 550 ), tfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "TFA analysis failed" );
				System.out.println( e.toString() );
	...
	public void f1_sfa_fifoMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA FIFO delay", Num.createNum( 355, 6 ), sfa.getDelayBound() );
				assertEquals( "SFA FIFO backlog", Num.createNum( 625, 2 ), sfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "SFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f1_sfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA ARB delay", Num.createNum( 235, 3 ), sfa.getDelayBound() );
				assertEquals( "SFA ARB backlog", Num.createNum( 1225, 3 ), sfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "SFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f1_pmoo_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "PMOO ARB delay", Num.createNum( 190, 3  ), pmoo.getDelayBound() );
				assertEquals( "PMOO ARB backlog", Num.createNum( 1000, 3 ), pmoo.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "PMOO analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f1_sinktree_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "Tree backlog", 550, backlog_bound, 0.0 );
			} catch (Exception e) {
