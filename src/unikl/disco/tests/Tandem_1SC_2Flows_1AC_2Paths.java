 ...
 *
 */
public class Tandem_1SC_2Flows_1AC_2Paths extends FunctionalTests
{
	static Network network;
	static Server s0, s1;
	static Flow f0, f1;
	 
	public Tandem_1SC_2Flows_1AC_2Paths( FunctionalTestConfig test_config ) {
		super( test_config );
	}
	...
	public void createNetwork()
	{
		...
		try {	
			...
			f1 = network.addFlow( arrival_curve, s1 );
		} catch (Exception e) {
			System.out.println( e.toString() );
			assertEquals( "Unexpected exception occured", 0, 1 );
			return;
	...
	public void f0_tfa_fifoMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "TFA FIFO delay", Num.createNum( 48.75 ), tfa.getDelayBound() );
				assertEquals( "TFA FIFO backlog", Num.createNum( 350 ), tfa.getBacklogBound() );
			} catch (Exception e) {
	...
	public void f0_tfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "TFA ARB delay", Num.createNum( 305, 4 ), tfa.getDelayBound() );
				assertEquals( "TFA ARB backlog", Num.createNum( 350 ), tfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "TFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f0_sfa_fifoMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA FIFO delay", Num.createNum( 515, 12 ), sfa.getDelayBound() );
				assertEquals( "SFA FIFO backlog", Num.createNum( 925, 4 ), sfa.getBacklogBound() );
			} catch (Exception e) {
	...
	public void f0_sfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA ARB delay", Num.createNum( 50 ), sfa.getDelayBound() );
				assertEquals( "SFA ARB backlog", Num.createNum( 800, 3 ), sfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "SFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f0_pmoo_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "PMOO ARB delay", Num.createNum( 50 ), pmoo.getDelayBound() );
				assertEquals( "PMOO ARB backlog", Num.createNum( 800, 3 ), pmoo.getBacklogBound() );
			} catch (Exception e) {
	...
	public void f0_sinktree_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "Tree backlog", 350, backlog_bound, 0.0 );
			} catch (Exception e) {
	...
	public void f1_tfa_fifoMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "TFA FIFO delay", Num.createNum( 55, 2 ), tfa.getDelayBound() );
				assertEquals( "TFA FIFO backlog", Num.createNum( 350 ), tfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "TFA analysis failed" );
				System.out.println( e.toString() );
	...
	public void f1_tfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "TFA ARB delay", Num.createNum( 55 ), tfa.getDelayBound() );
				assertEquals( "TFA ARB backlog", Num.createNum( 350 ), tfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "TFA analysis failed" );
				System.out.println( e.toString() );
	...
	public void f1_sfa_fifoMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA FIFO delay", Num.createNum( 335, 12 ), sfa.getDelayBound() );
				assertEquals( "SFA FIFO backlog", Num.createNum( 625, 4 ), sfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "SFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f1_sfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA ARB delay", Num.createNum( 110, 3 ), sfa.getDelayBound() );
				assertEquals( "SFA ARB backlog", Num.createNum( 200 ), sfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "SFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f1_pmoo_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "PMOO ARB delay", Num.createNum( 110, 3 ), pmoo.getDelayBound() );
				assertEquals( "PMOO ARB backlog", Num.createNum( 200 ), pmoo.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "PMOO analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
