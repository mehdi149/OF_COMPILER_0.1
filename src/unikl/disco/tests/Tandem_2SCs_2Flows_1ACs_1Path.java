 ...
 *
 */
public class Tandem_2SCs_2Flows_1ACs_1Path extends FunctionalTests
{
	static Network network;
	static Server s0, s1;
	static Flow f0, f1;
	 
	public Tandem_2SCs_2Flows_1ACs_1Path( FunctionalTestConfig test_config ) {
		super( test_config );
	}
	...
	public void createNetwork()
	{
		...
		ArrivalCurve arrival_curve = ArrivalCurve.createTokenBucket( 2.5, 12.5 );
	...
	public void f0_tfa_fifoMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "TFA FIFO delay", Num.createNum( 31 ), tfa.getDelayBound() );
				assertEquals( "TFA FIFO backlog", Num.createNum( 105 ), tfa.getBacklogBound() );
			} catch (Exception e) {
	...
	public void f0_tfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "TFA ARB delay", Num.createNum( 136 ), tfa.getDelayBound() );
				assertEquals( "TFA ARB backlog", Num.createNum( 105 ), tfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "TFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f0_sfa_fifoMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA FIFO delay", Num.createNum( 379, 14 ), sfa.getDelayBound() );
				assertEquals( "SFA FIFO backlog", Num.createNum( 71.25 ), sfa.getBacklogBound() );
			} catch (Exception e) {
	...
	public void f0_sfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA ARB delay", Num.createNum( 277, 7 ), sfa.getDelayBound() );
				assertEquals( "SFA ARB backlog", Num.createNum( 102.5 ), sfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "SFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f0_pmoo_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "PMOO ARB delay", Num.createNum( 242, 7 ), pmoo.getDelayBound() );
				assertEquals( "PMOO ARB backlog", Num.createNum( 90 ), pmoo.getBacklogBound() );
			} catch (Exception e) {
	...
	public void f0_sinktree_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "Tree backlog", 105, backlog_bound, 0.0 );
			} catch (Exception e) {
