	...
	public void f0_tfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "TFA ARB delay", Num.createNum( 31 ), tfa.getDelayBound() );
	...
	public void f0_sfa_fifoMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA FIFO delay", Num.createNum( 121, 6 ), sfa.getDelayBound() );
				assertEquals( "SFA FIFO backlog", Num.createNum( 105 ), sfa.getBacklogBound() );
			} catch (Exception e) {
	...
	public void f0_sfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA ARB delay", Num.createNum( 121, 6 ), sfa.getDelayBound() );
				assertEquals( "SFA ARB backlog", Num.createNum( 105 ), sfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "SFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f0_pmoo_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "PMOO ARB delay", Num.createNum( 121, 6 ), pmoo.getDelayBound() );
				assertEquals( "PMOO ARB backlog", Num.createNum( 105 ), pmoo.getBacklogBound() );
			} catch (Exception e) {
