 ...
 *
 */
public class Tandem_1SC_4Flows_1AC_1Path extends FunctionalTests
{
	static Network network;
	static Server s0, s1;
	static Flow f0, f1, f2, f3;
	 
	public Tandem_1SC_4Flows_1AC_1Path( FunctionalTestConfig test_config ) {
		super( test_config );
	}
	...
	public void createNetwork()
	{
		...
		ArrivalCurve arrival_curve = ArrivalCurve.createTokenBucket( 2, 10 );
	...
	public void f0_tfa_fifoMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "TFA FIFO delay", Num.createNum( 36 ), tfa.getDelayBound() );
				assertEquals( "TFA FIFO backlog", Num.createNum( 200 ), tfa.getBacklogBound() );
			} catch (Exception e) {
	...
	public void f0_tfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "TFA ARB delay", Num.createNum( 180 ), tfa.getDelayBound() );
				assertEquals( "TFA ARB backlog", Num.createNum( 200 ), tfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "TFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f0_sfa_fifoMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA FIFO delay", Num.createNum( 34.5 ), sfa.getDelayBound() );
				assertEquals( "SFA FIFO backlog", Num.createNum( 74 ), sfa.getBacklogBound() );
			} catch (Exception e) {
	...
	public void f0_sfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA ARB delay", Num.createNum( 82.5 ), sfa.getDelayBound() );
				assertEquals( "SFA ARB backlog", Num.createNum( 170 ), sfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "SFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f0_pmoo_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "PMOO ARB delay", Num.createNum( 60 ), pmoo.getDelayBound() );
				assertEquals( "PMOO ARB backlog", Num.createNum( 125 ), pmoo.getBacklogBound() );
			} catch (Exception e) {
