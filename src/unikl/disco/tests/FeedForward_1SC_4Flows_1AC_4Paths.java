	...
	public void f0_tfa_fifoMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "TFA FIFO delay", Num.createNum( 3735, 32 ), tfa.getDelayBound() );
				assertEquals( "TFA FIFO backlog", Num.createNum( 975 ), tfa.getBacklogBound() );
			} catch (Exception e) {
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				if( test_config.arrivalBoundMethods().size() == 1
					...
					assertEquals( "TFA ARB delay", Num.createNum( 2765, 6 ), tfa.getDelayBound() );
					assertEquals( "TFA ARB backlog", Num.createNum( 8525, 6 ), tfa.getBacklogBound() );
				} else {
					assertEquals( "TFA ARB delay", Num.createNum( 1370, 3 ), tfa.getDelayBound() );
					assertEquals( "TFA ARB backlog", Num.createNum( 1400 ), tfa.getBacklogBound() );
				}
			} catch (Exception e) {
				System.out.println( "TFA analysis failed" );
				System.out.println( e.toString() );
	...
	public void f0_sfa_fifoMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				// PBOO AB
				assertEquals( "SFA FIFO delay", Num.createNum( 1525, 16 ), sfa.getDelayBound() );
				assertEquals( "SFA FIFO backlog", Num.createNum( 7825, 16 ), sfa.getBacklogBound() );
			} catch (Exception e) {
	...
	public void f0_sfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				if( test_config.arrivalBoundMethods().size() == 1
						&& test_config.arrivalBoundMethods().contains( ArrivalBoundMethod.PMOO ) ) {
					assertEquals( "SFA ARB delay", Num.createNum( 2345, 12 ), sfa.getDelayBound() );
					assertEquals( "SFA ARB backlog", Num.createNum( 11875, 12 ), sfa.getBacklogBound() );
				} else { // PBOO AB
					assertEquals( "SFA ARB delay", Num.createNum( 580, 3 ), sfa.getDelayBound() );
					assertEquals( "SFA ARB backlog", Num.createNum( 5875, 6 ), sfa.getBacklogBound() );
				}
			} catch (Exception e) {
				System.out.println( "SFA analysis failed" );
				System.out.println( e.toString() );
	...
	public void f0_pmoo_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				if( test_config.arrivalBoundMethods().size() == 1
						&& test_config.arrivalBoundMethods().contains( ArrivalBoundMethod.PMOO ) ) {
					assertEquals( "PMOO ARB delay", Num.createNum( 875, 4 ), pmoo.getDelayBound() );
					assertEquals( "PMOO ARB backlog", Num.createNum( 4425, 4 ), pmoo.getBacklogBound() );
				} else { // PBOO AB
					assertEquals( "PMOO ARB delay", Num.createNum( 650, 3 ), pmoo.getDelayBound() );
					assertEquals( "PMOO ARB backlog", Num.createNum( 6575, 6 ), pmoo.getBacklogBound() );
				}
			} catch (Exception e) {
	...
	{		
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "TFA FIFO delay", Num.createNum( 77.5 ), tfa.getDelayBound() );
				assertEquals( "TFA FIFO backlog", Num.createNum( 975 ), tfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "TFA analysis failed" );
				System.out.println( e.toString() );
	...
	public void f1_tfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				if( test_config.arrivalBoundMethods().size() == 1
						&& test_config.arrivalBoundMethods().contains( ArrivalBoundMethod.PMOO ) ) {
					assertEquals( "TFA ARB delay", Num.createNum( 2395, 6 ), tfa.getDelayBound() );
					assertEquals( "TFA ARB backlog", Num.createNum( 8525, 6 ), tfa.getBacklogBound() );
				} else {
					assertEquals( "TFA ARB delay", Num.createNum( 395 ), tfa.getDelayBound() );
					assertEquals( "TFA ARB backlog", Num.createNum( 1400 ), tfa.getBacklogBound() );
				}
			} catch (Exception e) {
				System.out.println( "TFA analysis failed" );
	...
	public void f1_sfa_fifoMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA FIFO delay", Num.createNum( 575, 8 ), sfa.getDelayBound() );
				assertEquals( "SFA FIFO backlog", Num.createNum( 2975, 8 ), sfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "SFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f1_sfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				if( test_config.arrivalBoundMethods().size() == 1
						&& test_config.arrivalBoundMethods().contains( ArrivalBoundMethod.PMOO ) ) {
					assertEquals( "SFA ARB delay", Num.createNum( 2095, 12 ), sfa.getDelayBound() );
					assertEquals( "SFA ARB backlog", Num.createNum( 10625, 12 ), sfa.getBacklogBound() );
				} else { // PBOO AB
					assertEquals( "SFA ARB delay", Num.createNum( 345, 2 ), sfa.getDelayBound() );
					assertEquals( "SFA ARB backlog", Num.createNum( 875 ), sfa.getBacklogBound() );
				}
			} catch (Exception e) {
				System.out.println( "SFA analysis failed" );
				System.out.println( e.toString() );
	...
	public void f1_pmoo_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				if( test_config.arrivalBoundMethods().size() == 1
						&& test_config.arrivalBoundMethods().contains( ArrivalBoundMethod.PMOO ) ) {
					assertEquals( "PMOO ARB delay", Num.createNum( 2095, 12 ), pmoo.getDelayBound() );
					assertEquals( "PMOO ARB backlog", Num.createNum( 10625, 12 ), pmoo.getBacklogBound() );
				} else { // PBOO AB
					assertEquals( "PMOO ARB delay", Num.createNum( 345, 2 ), pmoo.getDelayBound() );
					assertEquals( "PMOO ARB backlog", Num.createNum( 875 ), pmoo.getBacklogBound() );
				}
			} catch (Exception e) {
				System.out.println( "PMOO analysis failed" );
				System.out.println( e.toString() );
	...
	public void f2_tfa_fifoMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "TFA FIFO delay", Num.createNum( 1875, 32 ), tfa.getDelayBound() );
				assertEquals( "TFA FIFO backlog", Num.createNum( 3975, 8 ), tfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "TFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f2_tfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "TFA ARB delay", Num.createNum( 1105, 6 ), tfa.getDelayBound() );
				assertEquals( "TFA ARB backlog", Num.createNum( 2075, 3 ), tfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "TFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f2_sfa_fifoMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA FIFO delay", Num.createNum( 1695, 32 ), sfa.getDelayBound() );
				assertEquals( "SFA FIFO backlog", Num.createNum( 8875, 32 ), sfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "SFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f2_sfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA ARB delay", Num.createNum( 1625, 18 ), sfa.getDelayBound() );
				assertEquals( "SFA ARB backlog", Num.createNum( 4175, 9 ), sfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "SFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f2_pmoo_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "PMOO ARB delay", Num.createNum( 305, 3 ), pmoo.getDelayBound() );
				assertEquals( "PMOO ARB backlog", Num.createNum( 3125, 6 ), pmoo.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "PMOO analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f3_tfa_fifoMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "TFA FIFO delay", Num.createNum( 845, 8 ), tfa.getDelayBound() );
				assertEquals( "TFA FIFO backlog", Num.createNum( 975 ), tfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "TFA analysis failed" );
				System.out.println( e.toString() );
	...
	public void f3_tfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				if( test_config.arrivalBoundMethods().size() == 1
						&& test_config.arrivalBoundMethods().contains( ArrivalBoundMethod.PMOO ) ) {
					assertEquals( "TFA ARB delay", Num.createNum( 1400, 3 ), tfa.getDelayBound() );
					assertEquals( "TFA ARB backlog", Num.createNum( 8525, 6 ), tfa.getBacklogBound() );
				} else {
					assertEquals( "TFA ARB delay", Num.createNum( 462.5 ), tfa.getDelayBound() );
					assertEquals( "TFA ARB backlog", Num.createNum( 1400 ), tfa.getBacklogBound() );
				}
			} catch (Exception e) {
				System.out.println( "TFA analysis failed" );
	...
	public void f3_sfa_fifoMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA FIFO delay", Num.createNum( 1405, 16 ), sfa.getDelayBound() );
				assertEquals( "SFA FIFO backlog", Num.createNum( 7225, 16 ), sfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "SFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f3_sfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA ARB delay", Num.createNum( 560, 3 ), sfa.getDelayBound() );
				assertEquals( "SFA ARB backlog", Num.createNum( 5675, 6 ), sfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "SFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f3_pmoo_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "PMOO ARB delay", Num.createNum( 1145, 6 ), pmoo.getDelayBound() );
				assertEquals( "PMOO ARB backlog", Num.createNum( 2900, 3 ), pmoo.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "PMOO analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
