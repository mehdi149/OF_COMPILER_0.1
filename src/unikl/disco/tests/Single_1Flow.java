	...
	public void f0_tfa_fifoMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "TFA FIFO delay", Num.createNum( 12.5 ), tfa.getDelayBound() );
				assertEquals( "TFA FIFO backlog", Num.createNum( 75 ), tfa.getBacklogBound() );
			} catch (Exception e) {
	...
	public void f0_tfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "TFA ARB delay", Num.createNum( 12.5 ), tfa.getDelayBound() );
				assertEquals( "TFA ARB backlog", Num.createNum( 75 ), tfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "TFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f0_sfa_fifoMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA FIFO delay", Num.createNum( 12.5 ), sfa.getDelayBound() );
				assertEquals( "SFA FIFO backlog", Num.createNum( 75 ), sfa.getBacklogBound() );
			} catch (Exception e) {
	...
	public void f0_sfa_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "SFA ARB delay", Num.createNum( 12.5 ), sfa.getDelayBound() );
				assertEquals( "SFA ARB backlog", Num.createNum( 75 ), sfa.getBacklogBound() );
			} catch (Exception e) {
				System.out.println( "SFA analysis failed" );
				System.out.println( e.toString() );
				System.out.println();
	...
	public void f0_pmoo_arbMux()
	{
		...
		if( test_config.fullConsoleOutput() ) {
			...
			try {
				...
				assertEquals( "PMOO ARB delay", Num.createNum( 12.5 ), pmoo.getDelayBound() );
				assertEquals( "PMOO ARB backlog", Num.createNum( 75 ), pmoo.getBacklogBound() );
			} catch (Exception e) {
